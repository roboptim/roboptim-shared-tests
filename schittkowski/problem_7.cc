...
namespace roboptim
{
  namespace schittkowski
  {
	...
	static const double fx;
      ...
      const double ExpectedResult::f0 = std::log (5) - 2;
      const double ExpectedResult::x[] = {0., std::sqrt (3)};
      const double ExpectedResult::fx = - std::sqrt (3);
