...
namespace roboptim
{
  namespace schittkowski
  {
	...
	static const double fx;
      ...
      const double ExpectedResult::f0 = -1808.858296;
      const double ExpectedResult::x[] = {14.095, 0.84296079};
      const double ExpectedResult::fx = -6961.81381;
...
BOOST_AUTO_TEST_CASE (schittkowski_problem19)
{
  ...
  OptimizationLogger<solver_t> logger
    (solver,
     "/tmp/roboptim-shared-tests/" SOLVER_NAME "/schittkowski/problem-19");
