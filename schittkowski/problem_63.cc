...
namespace roboptim
{
  namespace schittkowski
  {
	...
	static const double fx;
      ...
      const double ExpectedResult::f0 = 976;
      const double ExpectedResult::x[] = {3.512118414, 0.2169881741,
                                          3.552174034};
      const double ExpectedResult::fx = 961.7151721;
...
BOOST_AUTO_TEST_CASE (schittkowski_problem63)
{
  ...
  OptimizationLogger<solver_t> logger
    (solver,
     "/tmp/roboptim-shared-tests/" SOLVER_NAME "/schittkowski/problem-63");
