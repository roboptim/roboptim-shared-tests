...
BOOST_AUTO_TEST_CASE (schittkowski_problem18)
{
  ...
  expectedResult.f0 = 4.04;
  expectedResult.x = (ExpectedResult::argument_t (2) << std::sqrt (250), std::sqrt (2.5)).finished ();
  expectedResult.fx = 5.;
  ...
  SET_OPTIMIZATION_LOGGER (solver, "schittkowski/problem-18");
