...
namespace roboptim
{
  namespace schittkowski
  {
	...
	static const double fx;
      ...
      const double ExpectedResult::x[] = {0., std::sqrt (2), std::sqrt (2)};
      const double ExpectedResult::fx = std::sqrt(2) - 6.;
	...
	const throw ()
      {
	result[0] = (x[0] - 1) * (x[0] - 2) * (x[0] - 3) + x[2];
      }
	...
	const throw ()
      {
	result[0] = x[2] * x[2] - x[1] * x[1] - x[0] * x[0];
      }
	...
	const throw ()
      {
	result[0] = x[0] * x[0] + x[1] * x[1] + x[2] * x[2] - 4.;
      }
    ...
    } // end of namespace problem33.
  } // end of namespace schittkowski.
} // end of namespace roboptim.

BOOST_FIXTURE_TEST_SUITE (schittkowski, TestSuiteConfiguration)

BOOST_AUTO_TEST_CASE (schittkowski_problem33)
{
  using namespace roboptim;
  using namespace roboptim::schittkowski::problem33;
  ...
  OptimizationLogger<solver_t> logger
    (solver,
     "/tmp/roboptim-shared-tests/" SOLVER_NAME "/schittkowski/problem-33");
