...
namespace roboptim
{
  namespace schittkowski
  {
	...
	static const double fx;
      ...
      const double ExpectedResult::f0 = std::exp (-8) - 0.5;
      const double ExpectedResult::x[] = {-1.717142, 1.159571, 1.827248,
                                          -0.7636474, -0.7636390};
...
BOOST_AUTO_TEST_CASE (schittkowski_problem81)
{
  ...
  OptimizationLogger<solver_t> logger
    (solver,
     "/tmp/roboptim-shared-tests/" SOLVER_NAME "/schittkowski/problem-81");
