...
namespace roboptim
{
  namespace schittkowski
  {
	...
	static const double fx;
      ...
      const double ExpectedResult::x[] = {-33./43., 11./43., 27./43.,
                                          -5./43., 11./43.};
      const double ExpectedResult::fx = 176./43.;
	...
	grad.insert (1) = -2. * (x[0] - x[1]) + 2. * (x[1] + x[2] - 2);
    ...
    } // end of namespace problem53.
  } // end of namespace schittkowski.
} // end of namespace roboptim.

BOOST_FIXTURE_TEST_SUITE (schittkowski, TestSuiteConfiguration)

BOOST_AUTO_TEST_CASE (schittkowski_problem53)
{
  using namespace roboptim;
  using namespace roboptim::schittkowski::problem53;
  ...
  OptimizationLogger<solver_t> logger
    (solver,
     "/tmp/roboptim-shared-tests/" SOLVER_NAME "/schittkowski/problem-53");
